...
var str = "JS 코드를 함수가 아닌 JS파일 또는 script 태그 내부에 바로 작성하면"
        + "HTML 랜더링 시 바로 수행된다.";

console.log(str);
// alert(str);  새로고침하면 바로 실행됨
...
function test() {
    ...
    console.log("if문 종료 후 num5 : " + num5); // function의 지역변수
...
function typeTest(){
    ...
    console.log(temp1);
    // console.log(temp2);   if문 종료시 사용 불가
    // console.log(temp3);
    ...
    typeBox.innerHTML = ""; // type박스 요소 내부의 내용을 빈 문자열로 바꿔라
                            // == 내부 내용 삭제
