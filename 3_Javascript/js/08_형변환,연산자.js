...
document.getElementById("btn4").addEventListener("click", function(){
    // rgb 색상 랜덤 대입 (0 ~ 255)
    const r = Math.floor(Math.random() * 256)  // 0.0 <= ran(소수) < 256.0
    const g = Math.floor(Math.random() * 256)  // 0.0 <= ran(소수) < 256.0
    const b = Math.floor(Math.random() * 256)  // 0.0 <= ran(소수) < 256.0
