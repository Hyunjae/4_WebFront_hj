...
function getInnerHTML1(){
    // HTML 문서 내에서 id 속성 값이 test1인 요소를 얻어와
    // 상수형 변수 t1에 저장

    const t1 = document.getElementById("test1");

    // 브라우저 콘솔에 출력 == 자바의 println
    console.log(t1.innerHTML);
    // p태그 안의 내용만 문자열로 반환됨
}

// innerHTML로 변경하기(태그, 속성이 해석됨 (HTML Converter 이용, 속도가 느려서 권장x))
...
function getInnerText1(){
    // clg 자동완성 -> console.log() (단, JS ES6 snippets 설치 필요)
